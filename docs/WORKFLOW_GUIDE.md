...
>
> 适用版本：`v7.0.0-generative-biophysics` 及以上（C2 曲面族章对应 2026-09 打磨轮）。
...
31. [隐式神经场（SIREN）潜在拓扑流形探索](#三十一隐式神经场siren潜在拓扑流形探索--v70) 🆕 v7.0
32. [三维多轴各向异性屈服面与多孔破坏裕度分析](#三十二三维多轴各向异性屈服面与多孔破坏裕度分析--v70) 🆕 v7.0
33. [声子晶体能带色散与超材料宽频振动隔离设计](#三十三声子晶体能带色散与超材料宽频振动隔离设计--v70) 🆕 v7.0
34. [组织工程成骨长入与微流体氧气输运反应-扩散仿真](#三十四组织工程成骨长入与微流体氧气输运反应-扩散仿真--v70) 🆕 v7.0
35. [水平集拓扑导数自适应多目标优化重构](#三十五水平集拓扑导数自适应多目标优化重构--v70) 🆕 v7.0
36. [C2 曲面族扩展与可用域速查](#三十六c2-曲面族扩展与可用域速查--v70) 🆕 v7.0+
