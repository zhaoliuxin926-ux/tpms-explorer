...
| 6 | 0:37–0:43 | 层位 Z 滑块扫过三层断面 | "逐层检查断面拓扑，导出 SVG 或工业 CLI 格式交给切片机。" |
| 尾 | 0:43+ | （录屏素材止；建议补录）CLI 水密输出 + GitHub 首页 | "从数学到交付：44 道 CI 门禁三平台守护。github.com/zhaoliuxin926-ux/tpms-explorer" |
