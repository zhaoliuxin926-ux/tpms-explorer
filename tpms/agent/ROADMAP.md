...
- [ ] C2 剩余差集：C(D)（Complementary D，谐波 3×，MiniSurf 展示方程已提取——cos(3x+y)cosz 等混合角项，待与 R120 同域验证）、Slotted P、F、Q*、W（**不在 MiniSurf 清单**，须另寻可靠文献源；官方源码双胞/Double 系列已在第三批以展示方程落地）——R128 实用性依赖求解性能优化
