...
// ── 6. list：19 内置曲面（C2 第一批 +5、第二批 +1、第三批 +4、第四批 +1）+ 材料表字段完整 ──
const rl = JSON.parse(run('list', '--json').stdout);
rl.types.length === 19 && rl.types.every((t) => t.C1 > 0 && t.anisotropy > 1) && rl.materials.tc4.modulusGPa === 110
  ? ok('list 含 19 曲面且常数/材料表完整') : bad('list', JSON.stringify(rl.types?.length));
