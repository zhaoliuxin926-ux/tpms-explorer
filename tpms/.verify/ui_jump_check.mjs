...
ok('分组计数 12/9/1/5 = 27（试验曲线反演 sect 纳入仿真组，2026-09-13）', counts.geometry === 12 && counts.sim === 9 && counts.optimize === 1 && counts.view === 5 && counts.total === 27, JSON.stringify(counts));
