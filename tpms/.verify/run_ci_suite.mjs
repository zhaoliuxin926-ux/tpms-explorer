...
//
// 调度：44 门全部自包含（各门自带服务/临时 bundle 名互不碰撞），按并发池执行；
...
const SCHEDULE = [
  ...
  ['conformal_fill_audit C5 保形填充（门44，15断言——2026-09-13 口径专项 +容器体积对拍/孔隙率闭环/envelope换算）', '流形保形填充', 'conformal_fill_audit.mjs'],
