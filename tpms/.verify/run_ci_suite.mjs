...
const STEP_TIMEOUT_MS = (() => {
  const n = Number(process.env.STEP_TIMEOUT_MS);
...
const SCHEDULE = [
  ...
  ['docs_consistency_check 文档数字一致性（GUARD↔宣称/禁句/publish 同源+sync-publish/调色单例/徽章↔tag，80 断言）', '文档一致性', 'docs_consistency_check.mjs'],
