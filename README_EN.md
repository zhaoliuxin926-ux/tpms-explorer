...
node tpms/agent/schema_check.mjs --fast           # contract/static/reject, 50 assertions
node tpms/.verify/docs_consistency_check.mjs      # docs number consistency, 50 assertions
